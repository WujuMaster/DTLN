...
sample_path = './samples/vn_noisy.wav'
enhanced = './samples/enhanced_vn_noisy.wav'
...
interpreter_1 = tflite.Interpreter(
    model_path='./pretrained_model/TFLite/DTLN_8khz_model_1.tflite')
interpreter_1.allocate_tensors()
interpreter_2 = tflite.Interpreter(
    model_path='./pretrained_model/TFLite/DTLN_8khz_model_2.tflite')
...
print('Processing Time [ms]:', np.mean(np.stack(time_array))*1000)
print('Whole Time [s]:', np.sum(np.stack(time_array)))

...
class audio_generator():
    ...
    def count_samples(self):
        ...
        self.file_names = fnmatch.filter(
            os.listdir(self.path_to_input), '*.wav')
...
class DTLN_model():
    ...
    def build_DTLN_model(self, norm_stft=False):
        ...
        encoded_frames = Conv1D(self.encoder_size, 1,
                                strides=1, use_bias=False)(estimated_frames_1)
    ...
    def create_tf_lite_model(self, weights_file, target_name, use_dynamic_range_quant=False):
        ...
        model_1 = Model(inputs=[mag, states_in_1],
                        outputs=[mask_1, states_out_1])
    ...
    def train_model(self, runName, path_to_train_mix, path_to_train_speech,
        ...
        savePath = './pretrained_model/' + runName + '/'
        ...
        dataset_val = dataset_val.batch(
            self.batchsize, drop_remainder=True).repeat()

...
# path to the weights of the model to continue training
weights_path = './pretrained_model/model_weights/DTLN_model.h5'

# name your training run
runName = 'DTLN_model_8khz'
...
# load weights to continue training, or else remove this
# modelTrainer.model.load_weights(weights_path)
# train the model
